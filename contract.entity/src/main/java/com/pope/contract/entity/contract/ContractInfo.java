...
public class ContractInfo implements Serializable {
    ...
    public void setHtsj(String htsj) {
        this.htsj = htsj == null ? null : htsj.trim();
    }

    public String getHtzxsj() {
        return htzxsj;
    }

    public void setHtzxsj(String htzxsj) {
        this.htzxsj = htzxsj == null ? null : htzxsj.trim();
    }
