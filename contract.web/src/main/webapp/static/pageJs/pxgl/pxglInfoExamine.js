...
$(document).ready(function(){
	...
	function queryList(pageId){
		...
		$("#tblTaskInfo").empty();
		doGet(basePath+"/pxglExamineInfo/listDsh","startPage="+pageId,function(data){
			if(data.data.data){
			...
			$("#mainTable").delegate("[data-option='pass']","click",function(){
				...
				confirm("您确认该任务审核通过吗？",function(data){
					doPost(basePath+"/pxglExamineInfo/examinePass", "wid="+key, function(data) {
			...
			$("#mainTable").delegate("[data-option='notPass']","click",function(){
				var key=$(this).attr("data-key");
				confirm("您确认该任务审核不通过吗？",function(data){
					doPost(basePath+"/pxglExamineInfo/examineNotPass", "wid="+key, function(data) {
						window.location.reload();
					});
				});
			});
	...
	function queryJxz(pageId){
		...
		doGet(basePath+"/pxglExamineInfo/listJxz","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShtg(pageId){
		...
		doGet(basePath+"/pxglExamineInfo/listShtg","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShbtg(pageId){
		...
		doGet(basePath+"/pxglExamineInfo/listShbtg","startPage="+pageId,function(data){
			if(data.data.data){
