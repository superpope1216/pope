...
$(document).ready(function(){
	...
	function queryList(pageId){
		...
		$("#tblTaskInfo").empty();
		doGet(basePath+"/lqbExamine/listDsh","startPage="+pageId,function(data){
			if(data.data.data){
			...
			$("#mainTable").delegate("[data-option='pass']","click",function(){
				...
				confirm("您确认该项目任务审核通过吗？",function(data){
					doPost(basePath+"/lqbExamine/examinePass", "wid="+key, function(data) {
			...
			$("#mainTable").delegate("[data-option='notPass']","click",function(){
				...
				confirm("您确认该项目任务审核不通过吗？",function(data){
					doPost(basePath+"/lqbExamine/examineNotPass", "wid="+key, function(data) {
						window.location.reload();
					});
				});
			});
	...
	function queryJxz(pageId){
		...
		doGet(basePath+"/lqbExamine/listJxz","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShtg(pageId){
		...
		doGet(basePath+"/lqbExamine/listShtg","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShbtg(pageId){
		...
		doGet(basePath+"/lqbExamine/listShbtg","startPage="+pageId,function(data){
			if(data.data.data){
	...
	$("#btnSubmitSh").click(function(){
		...
		doPost(basePath+"/lqbExamine/submitTaskInfo", "datas="+JSON.stringify(saveData), function(data) {
			alert("提交成功");
			window.location.reload();
		});
	});
