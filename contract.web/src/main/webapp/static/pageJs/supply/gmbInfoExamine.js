...
$(document).ready(function(){
	...
	function queryList(pageId){
		...
		$("#tblTaskInfo").empty();
		doGet(basePath+"/gmbExamine/listDsh","startPage="+pageId,function(data){
			if(data.data.data){
			...
			$("#mainTable").delegate("[data-option='pass']","click",function(){
				...
				confirm("您确认该项目任务审核通过吗？",function(data){
					doPost(basePath+"/gmbExamine/examinePass", "wid="+key, function(data) {
			...
			$("#mainTable").delegate("[data-option='notPass']","click",function(){
				...
				confirm("您确认该项目任务审核不通过吗？",function(data){
					doPost(basePath+"/gmbExamine/examineNotPass", "wid="+key, function(data) {
						window.location.reload();
					});
				});
			});
	...
	function queryJxz(pageId){
		...
		doGet(basePath+"/gmbExamine/listJxz","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShtg(pageId){
		...
		doGet(basePath+"/gmbExamine/listShtg","startPage="+pageId,function(data){
			if(data.data.data){
	...
	function queryShbtg(pageId){
		...
		doGet(basePath+"/gmbExamine/listShbtg","startPage="+pageId,function(data){
			if(data.data.data){
	...
	$("#btnSubmitSh").click(function(){
		...
		doPost(basePath+"/gmbExamine/submitTaskInfo", "datas="+JSON.stringify(saveData), function(data) {
			alert("提交成功");
			window.location.reload();
		});
	});
