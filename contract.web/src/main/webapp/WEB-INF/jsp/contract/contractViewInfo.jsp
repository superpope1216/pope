								...
								<div class="panel-body">
									<table style="width: 100%; margin-top: 5px;">
										<tr>
											...
											<td align="right">
											<button
													class="btn btn-primary btnQuery" style="display:none;" type="button" id="btnEditContract">编辑</button>
											<button
													class="btn btn-primary btnQuery" style="display:none;" type="button" id="btnSave" style="display:none;">保存</button>
												<button
													class="btn btn-danger btnQuery" style="display:none;" type="button" id="btnTish">提交审核</button>
											</td>
										</tr>
									</table>
									<form class="form-horizontal" id="userViewForm"
										...
										<table class="mainTable">
											<tr>
												...
												type="hidden" name="dqbh" value="">合同类型</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htlx"></p></td>
												<td class="tbl-two-text">合同名称</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htmc"></p></td>
											</tr>
											<tr>
												<td class="tbl-two-text">合同编号</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htbh"></p></td>
												<td class="tbl-two-text">合同甲方</td>
												<td class="tbl-two-edit-value">
												<p class="form-control-static" name="htjf"></p></td>
											</tr>
											<tr>
												<td class="tbl-two-text">项目负责人</td>
												<td class="tbl-two-edit-value">
												<p class="form-control-static" name="xmfzr"></p></td>
												<td class="tbl-two-text">合同金额</td>
												<td class="tbl-two-edit-value">
												<p class="form-control-static" name="htje">0</p></td>
											</tr>
											<tr>
												<td class="tbl-two-text">合同折扣</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htzk">0</p></td>
												<td class="tbl-two-text">合同时间</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htsj"></p></td>
											</tr>
											<tr>
												<td class="tbl-two-text">执行时间</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="htzxsj"></p></td>
												<td class="tbl-two-text">对方账号</td>
												<td class="tbl-two-edit-value"><p class="form-control-static" name="dfzh"></p></td>
											</tr>
											<tr>
									...
									<form class="form-horizontal" id="userForm"
										...
										<table class="mainTable">
											...
											<tr>
												...
												<td class="tbl-two-edit-value">
												<select name="htzk" class="form-control" placeholder="请输入合同折扣" required></select>
												</td>
												<td class="tbl-two-text">合同时间</td>
											...
											<tr>
												<td class="tbl-two-text">合同执行时间<span class="myrequrire">*</span></td>
												<td class="tbl-two-edit-value"><input type="text" class="form-control" name="htzxsj"
													placeholder="请输入合同执行时间" onClick="WdatePicker()" required></td>
												<td class="tbl-two-text">对方账号</td>
								...
								<div class="panel-body">
									...
									<table style="width: 100%; margin-top: 5px;">
										<tr>
											...
											<td align="right">
												<button class="btn btn-primary btnQuery" style="display:none;" type="button"
