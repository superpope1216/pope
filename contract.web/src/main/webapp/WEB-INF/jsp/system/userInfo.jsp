			...
			<div class="wrapper">
				...
				<div class="panel">
					<div class="panel-body">
						...
						<br> <br>
						<table class="table table-bordered datatable table-hover" id="mainTable">
							<thead>
								<tr>
	...
	<script id="tblUserInfoTpl" type="text/x-jquery-tmpl">
				<tr>
					...
					<td class="text-center"><div class="btn-group">
          								<button type="button" class="btn btn-xs btn-primary"><i class="icon icon-edit"></i>编辑</button>
			
          								<button type="button" style="margin-left:4px;" class="btn btn-xs btn-danger"><i class="icon icon-times"></i>删除</button>
        							</div></td>
				</tr>
			</script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/pageJs/system/userInfo.js"></script>
</body>
</html>